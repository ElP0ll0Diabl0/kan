...
| `KAN_SUPERADMIN_EMAILS`                   | Comma-separated emails granted superadmin access to the `/admin` area (self-hosted only) | For admin area | `admin@example.com,ops@example.com`                       |
